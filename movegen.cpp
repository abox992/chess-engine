...
int generateMoves(Board& board, struct Move moveList[], int color) {
    ...
    if constexpr (flag == 0) {
        ...
        moveMask = board.allPieces[!board.blackToMove];
    }
...
template int generateMoves<0>(Board& board, struct Move moveList[], int color);
template int generateMoves<1>(Board& board, struct Move moveList[], int color);
template int generateMoves<2>(Board& board, struct Move moveList[], int color);